...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8">
	  	...
	  	<meta name="author" content="ELMI WAHYU">
  		...
  		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		  		...
		  		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
					...
					<img src="Design/img/logokeepcut.png" alt="Barbershop Logo" width="100" height="100">
					</div>
					<div class="sidebar-brand-text mx-3">KEEPCUT STUDIO</div>
		  		</a>
